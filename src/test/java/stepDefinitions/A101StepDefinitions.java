...
public class A101StepDefinitions {
    ...
    @And("siyah renkli urunlerden bir tanesi secildi")
    public void siyahRenkliUrunlerdenBirTanesiSecildi() {

    }
    @Then("acilan urunun siyah oldugu dogrulandi")
    public void acilan_urunlerin_siyah_oldugu_dogrulandi() {
...
Thread.sleep(1000);
        ...
        a101Page.adres.sendKeys("ataturk mh 3545sk no:33 ");
